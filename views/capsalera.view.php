...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav mr-auto">
    <li class="nav-item <?php if ($lang=='cat') {echo 'active';} ?>">
      <a class="nav-link" href="../public/changelang.php?lang=cat">CAT</a>
    </li>
    <li class="nav-item <?php if ($lang=='es') {echo 'active';}?>">
      <a class="nav-link" href="../public/changelang.php?lang=es">ES</a>
    </li>
  </ul>
</div>
</nav>
